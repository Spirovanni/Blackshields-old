...
describe('Service Tests', () => {
    ...
    describe('Colorsbackground Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ColorsbackgroundService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/colorsbackgrounds';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Colorsbackground', () => {

                let entity: Colorsbackground;
                service.find(123).subscribe((_entity: Colorsbackground) => {
                    entity = _entity;
                });
